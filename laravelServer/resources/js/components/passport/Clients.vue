...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                axios.get(`oauth/clients`, {baseURL: Laravel.baseUrl})
                    .then(response => {
            ...
            persistClient(method, uri, form, modal) {
                ...
                axios[method](uri, form, {baseURL: Laravel.baseUrl})
                    .then(response => {
                        this.getClients();
             ...
             */
            destroy(client) {
                axios.delete(`oauth/clients/${client.id}`, {baseURL: Laravel.baseUrl})
                    .then(response => {
                        this.getClients();
                    });
            }
