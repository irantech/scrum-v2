...
<template>
  <div>
    ...
    <div class="container">
      ...
      <Tabs value="name1" @on-click="getTabData">
        <TabPane label="تسک های زمان داده شده"  name="given_time">
        ...
        <TabPane label="تسک های زمان داده نشده"  name="no_time_given">
        ...
        <TabPane label="تسک های آرشیوی"  name="archive_tasks">آرشیوی</TabPane>
      </Tabs>
