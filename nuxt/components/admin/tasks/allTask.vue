    ...
    <section class="scrum-task">
      <div class="container">
        ...
        <div class="parent-scrum-task">
          <div class="parent-contract-all" v-for="(contract , tasks_index) in task_all" :key="tasks_index"  v-if="contract.tasks.length > 0 " >
            <article  v-for="(task , index) in contract.tasks" :key="index"  class="scrum-task-item">
              <div class="parent-title-calendar">
                ...
                <div class="parent-calendar-scrum-task-item">
                  ...
                  <span>{{ task.contract.start_date }}</span>
                </div>
              </div>
